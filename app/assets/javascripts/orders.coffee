...
document.addEventListener 'turbolinks:load', (event) ->
	submitBtn = document.getElementById('submitNewOrder')
	...
	submitBtn.onclick = ->
		...
		date_selection = document.getElementById('date_selection')
		selectedDate = date_selection.options[date_selection.selectedIndex].text
		...
		while i < allSelect.length
			...
			if selectElement.id != 'pickupTime' && selectElement.id != 'date_selection'
