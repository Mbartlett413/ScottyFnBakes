...
Loaf.create( name: 'Babka', ingredients: '', active_item: true, price: 0, category_id: cat1.id)
Loaf.create( name: 'Brioche', ingredients: '', active_item: true, price: 0, category_id: cat1.id)
Loaf.create( name: 'Challa', ingredients: '', active_item: true, price: 0, category_id: cat1.id)
Loaf.create( name: 'Pumpernickel', ingredients: '', active_item: true, price: 0, category_id: cat1.id)
Loaf.create( name: 'Seasonal', ingredients: '', active_item: true, price: 0, category_id: cat1.id)
Loaf.create( name: 'Apocalypse Bread', ingredients: '', active_item: true, price: 0, category_id: cat1.id)
Loaf.create( name: 'Sun Dried Tomato', ingredients: '', active_item: true, price: 0, category_id: cat1.id)
Loaf.create( name: 'Pesto', ingredients: '', active_item: true, price: 0, category_id: cat2.id)
Loaf.create( name: 'Bacon', ingredients: '', active_item: true, price: 0, category_id: cat2.id)
Loaf.create( name: 'Spinach', ingredients: '', active_item: true, price: 0, category_id: cat2.id)
